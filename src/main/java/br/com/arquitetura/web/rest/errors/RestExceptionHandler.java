package br.com.arquitetura.web.rest.errors;
...
public class RestExceptionHandler {
	...
	public ErrorDTO handleConstraintViolationException(ConstraintViolationException ex, HttpServletRequest request) {
		// @formatter:off
		ErrorDTO details = ErrorDTO.builder().status(HttpStatus.BAD_REQUEST.value()).error("Invalid request")
				.message("Validation Failed").path(request.getRequestURI()).build();
		// @formatter:on
